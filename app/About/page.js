    ...
    <>
        ...
        <div className="relative z-20 h-[calc(100%-96px)] flex items-center justify-center">
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
            ...
            <motion.h1
              ...
              className="text-6xl sm:text-7xl md:text-8xl xl:text-[120px] font-black text-white leading-none"
            >
              About us
            </motion.h1>
            ...
            >
              <Link
                href="/"
                className="text-white text-xl hover:text-[#00d2c6] transition duration-300"
              >
                Home
              </Link>

              <span className="text-[#00d2c6] text-xl">/</span>

              <span className="text-white text-xl font-semibold">About Us</span>
            </motion.div>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-[#f5f7f4] py-24 lg:py-26">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 items-start">
            ...
            >
              ...
              <div className="inline-flex items-center gap-3 rounded-full bg-white border border-[#d8e2dc] px-6 py-3 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-[#00d2c6]" />

                <span className="text-[#09284b] font-semibold text-lg">
                  Our Approach
                </span>
              </div>
              ...
              <div className="absolute right-6 top-[42%] w-4 h-4 rounded-full bg-cyan-500" />
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        {Array.from({ length: 5 }).map((_, i) => (
                          <span key={i} className="text-cyan-400 text-xl">
                            ★
                          </span>
                        ))}
                      </div>
            ...
            <div className="flex flex-col gap-4">
              {cards.map((card, index) => (
                ...
                >
                  ...
                  <div className="w-14 h-14 rounded-full bg-cyan-600 flex items-center justify-center text-[#09284b]">
                    {card.icon}
                  </div>

                  {/* TITLE */}

                  <h3 className="mt-3 text-[#09284b] text-2xl font-black">
                    {card.title}
                  </h3>
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          <div className="absolute top-20 left-20 w-[500px] h-[500px] rounded-full bg-[#00d2c6]/10 blur-[150px]" />
      ...
      <section className="relative overflow-hidden bg-[#f5f7f4] py-24 lg:py-32">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#7ef14d]/10 blur-[140px] rounded-full" />

          <div className="absolute bottom-0 right-0 w-[450px] h-[450px] bg-[#00d2c6]/10 blur-[140px] rounded-full" />
        </div>
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto px-3 md:px-5">
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-14 items-start">
            ...
            >
              ...
              <div className="inline-flex items-center gap-3 bg-white border border-[#dce6df] px-6 py-3 rounded-full shadow-sm">
                <span className="w-2.5 h-2.5 rounded-full bg-[#7ef14d]" />

                <span className="text-[#09284b] font-semibold text-md">
                  Our Benefits
                </span>
              </div>
              ...
              <h2 className="mt-8 text-[#09284b] text-3xl sm:text-4xl xl:text-5xl font-black leading-[1.06] tracking-[-2px] max-w-[850px]">
                The Value You Gain From Our Environmental Expertise
              </h2>

              {/* DESCRIPTION */}

              <p className="mt-8 text-[#64748b] text-md leading-[1.9] max-w-[760px]">
              ...
              <button className="group mt-10 inline-flex items-center overflow-hidden rounded-full bg-[#7ef14d] hover:bg-[#6fe041] transition-all duration-500">
                <span className="px-6 py-4 text-[#09284b] text-xl font-bold">
                  Learn More
                </span>

                <span className="flex h-[72px] w-[72px] items-center justify-center bg-[#09284b] text-white transition-all duration-500 group-hover:w-[82px]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
              ...
              <motion.div
                ...
                className="absolute right-10 top-[58%] w-4 h-4 rounded-full bg-[#7ef14d]"
              />
            </motion.div>
            ...
            <div className="space-y-8">
              {benefits.map((item, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group rounded-[32px] border border-[#dde5df] bg-[#eef1ed] px-6 py-6 md:px-7 md:py-7 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
                >
                  <div className="flex flex-col sm:flex-row gap-6">
                    {/* ICON */}

                    <div className="flex-shrink-0">
                      <div className="flex items-center justify-center w-14 h-14 rounded-full bg-[#7ef14d] text-[#09284b] shadow-lg">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                    ...
                    <div>
                      <h3 className="text-[#09284b] text-2xl font-black leading-tight">
                        {item.title}
                      </h3>

                      <p className="mt-5 text-[#64748b] text-md leading-[1.8] max-w-[650px]">
                        {item.description}
                      </p>
                    </div>
                  </div>
          ...
          >
            {tags.map((tag, index) => (
              <div
                key={index}
                className="inline-flex items-center gap-3 rounded-full bg-[#eef1ed] border border-[#dce5de] px-2 py-1 hover:bg-white transition-all duration-300"
              >
                <span className="w-2 h-2 rounded-full bg-[#7ef14d]" />

                <span className="text-[#09284b] text-md font-medium">
                  {tag}
                </span>
              </div>
            ))}
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <div className="-ml-3 flex items-center justify-center w-8 h-8 rounded-full bg-[#7ef14d] border-4 border-[#f5f7f4]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <p className="text-[#09284b] text-md">
              Let&apos;s make something great work together.
            </p>

            {/* LINK */}

            <button className="text-[#7ef14d] hover:text-[#00d2c6] transition-all duration-300 text-md font-semibold underline underline-offset-4">
              Get Free Quote
            </button>
          </motion.div>
        </div>
      ...
      <section className="relative min-h-screen overflow-hidden bg-[#071c34] text-white">
        ...
        {/* 🔵 Dark Overlay */}
        <div className="absolute inset-0 bg-[#071c34]/10" />

        {/* 🔵 Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#071c34] via-[#071c34]/20 to-transparent" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
          ...
          <motion.h1
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
            className="max-w-4xl text-4xl md:text-5xl font-bold leading-tight"
          >
          ...
          <motion.p
            ...
            className="max-w-2xl mt-4 text-lg text-gray-300 leading-relaxed"
          >
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16 max-w-4xl">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-cyan-400 to-teal-400 flex items-center justify-center mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <h2 className="text-3xl font-bold mb-2">5,000+</h2>
            ...
            <motion.div
              ...
              className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl"
            >
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 flex items-center justify-center mb-8">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mt-20 gap-10">
            ...
            >
              ...
              <span className="w-17 h-17 flex items-center justify-center bg-[#071c34] text-white group-hover:bg-black transition">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
      ...
      <section className="relative overflow-hidden bg-[#f5f7f4] py-24 lg:py-32">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#00d2c6]/10 blur-[120px] rounded-full" />
        </div>
        ...
        <div className="relative z-10 max-w-[1700px] mx-auto px-4 md:px-8">
          ...
          >
            ...
            <div className="inline-flex items-center gap-3 bg-white border border-[#dce5de] px-6 py-3 rounded-full shadow-sm">
              <span className="w-2.5 h-2.5 rounded-full bg-[#7ef14d]" />
            ...
            <h2 className="mt-8 text-[#09284b] text-5xl sm:text-6xl xl:text-7xl font-black leading-[1.08] tracking-[-2px]">
              The People Behind Our Mission
            </h2>

            {/* DESCRIPTION */}

            <p className="mt-8 mx-auto max-w-[950px] text-[#64748b] text-xl leading-[1.9]">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group rounded-[34px] border border-[#dde5de] bg-[#eef1ed] overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl"
              >
                {/* ===================================================== */}
                {/* IMAGE */}
                {/* ===================================================== */}
                ...
                <div className="relative overflow-hidden rounded-[30px] m-4">
                  ...
                  <motion.div
                    ...
                    className="absolute top-8 right-8 w-20 h-20 rounded-full bg-[#7ef14d]/30 backdrop-blur-xl border border-white/20"
                  />
                </div>
                ...
                <div className="px-8 pb-8">
                  <h3 className="text-[#09284b] text-4xl font-black">
                    {member.name}
                  </h3>
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    {[
                      ...
                      <button
                        key={i}
                        className="group/social flex items-center justify-center w-14 h-14 rounded-full border border-[#d6ded8] bg-white text-[#09284b] hover:bg-[#7ef14d] hover:border-[#7ef14d] transition-all duration-300"
                      >

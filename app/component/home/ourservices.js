    ...
    <>
      <section className="bg-[#0c264b] text-white py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            Delivering reliable software solutions that help businesses
            streamline operations, enhance productivity, and drive sustainable
            growth
          </motion.p>
          ...
          <motion.div
            ...
            className="grid md:grid-cols-3 gap-4 mt-16 relative overflow-hidden rounded-[28px] border border-white/5 bg-white/5 backdrop-blur-xl p-8 shadow-2xl"
          >
            {/* Card 1 */}
            <motion.div
              whileHover={{ y: -10 }}
              className=" p-6 w-88 rounded-2xl bg-[#0c264b]/70 border border-[#0bccc1]/20 shadow-lg text-left transition duration-300"
            >
              ...
              <p className="relative z-10 w-70 text-gray-300 text-md leading-relaxed mt-6">
            ...
            <motion.div
              whileHover={{ y: -10 }}
              className=" p-6 w-85 rounded-2xl bg-[#0c264b]/70 border border-[#0bccc1]/20 shadow-lg text-left transition duration-300"
            >
              <div className="w-12 h-12 bg-gradient-to-r from-[#0bccc1] to-[#07ebd1] text-white rounded-full flex items-center justify-center mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
